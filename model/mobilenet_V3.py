...
def mobilenetv3_large(**kwargs):
    ...
    cfgs = [
        # k, t, c, SE, HS, s
        [3,   1,  16, 0, 0, 1],   #out=bs,16,128,128]
        [3,   4,  24, 0, 0, 2],
        [3,   3,  24, 0, 0, 1],   #out=bs,24,64,64]
        [5,   3,  40, 1, 0, 2],
        [5,   3,  40, 1, 0, 1],
        [5,   3,  40, 1, 0, 1],   #out=bs,40,32,32]
        [3,   6,  80, 0, 1, 2],
        [3, 2.5,  80, 0, 1, 1],
        [3, 2.3,  80, 0, 1, 1],
        [3, 2.3,  80, 0, 1, 1],
        [3,   6, 112, 1, 1, 1],
        [3,   6, 112, 1, 1, 1],   #out=bs,112,16,16]
        [5,   6, 160, 1, 1, 2],
        [5,   6, 160, 1, 1, 1],
        [5,   6, 160, 1, 1, 1]    #out=bs,160,8,8]
    ]
...
def mobilenetv3_small(**kwargs):
    cfgs = [
        # k, t, c, SE, HS, s
        [3,    1,  16, 0, 1, 1],
        [3,    1,  16, 0, 1, 1],   #out=bs,16,128,128]
        [3,    3,  24, 0, 1, 2],
        [3,    3,  24, 0, 1, 1],   #out=bs,24,64,64]
        [5,    4,  40, 1, 1, 2],
        [5,    4,  40, 1, 1, 1],   #out=bs,40,32,32]
        [5,    6,  80, 1, 1, 2],
        [5,    6,  112, 1, 1, 1],   #out=bs,112,16,16]
        [5,    6,  160, 1, 1, 2],
        [5,    6,  160, 1, 1, 1],   #out=bs,160,8,8]
    ]
